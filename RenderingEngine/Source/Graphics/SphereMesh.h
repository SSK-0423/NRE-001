...
namespace NamelessEngine::Graphics
{
	...
	private:
		...
		void CreateVerticesAndIndicesData(SphereMeshData& data);
		...
		Utility::RESULT CreateGraphicsPipelineState(ID3D12Device& device, SphereMeshData& data);
	...
	public:
		Utility::RESULT Create(ID3D12Device& device, SphereMeshData& data);
